...
?>
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="info" placeholder="More Info"></textarea>
  </div>
...
<?php
    if(isset($_POST['submit']))
    {
		...
		*/
        ...
        $sql="INSERT INTO tb_report_bike (bike_id,user_email,date_stolen,location,lat,lng,info,reported_date) 
                            VALUES ('$_GET[bike_id]','$_SESSION[email]','$date','$location','$lat','$lng','$info','$reported_date')";
        if($mysqli->query($sql)){
       	$_SESSION['message'] = '  <div class="alert alert-success" role="alert">
        <strong>Reported!</strong> You have sucessfully reported your stolen bike.
        </div>';
		header("location: reported_bikes.php");
		}else{
		$_SESSION['message'] = '  <div class="alert alert-danger" role="alert">
        <strong>Ooops!</strong> unsucessfully in reporting your stolen bike.
        </div>';
